...
{
  dst->data[M4_RC_01] = dst->data[M4_RC_02] = dst->data[M4_RC_03] =
  dst->data[M4_RC_10] = dst->data[M4_RC_12] = dst->data[M4_RC_13] =
  dst->data[M4_RC_20] = dst->data[M4_RC_21] = dst->data[M4_RC_23] =
  dst->data[M4_RC_30] = dst->data[M4_RC_31] = dst->data[M4_RC_32] = 0.f;
  dst->data[M4_RC_00] = dst->data[M4_RC_11] = dst->data[M4_RC_22] =
  dst->data[M4_RC_33] = 1.f;
}
...
matrix4f_set_axisangle(matrix4f *dst, const vector3f *axis, float angle)
{
  ...
  dst->data[M4_RC_00] = tmp.data[M3_RC_00];
  dst->data[M4_RC_01] = tmp.data[M3_RC_01];
  dst->data[M4_RC_02] = tmp.data[M3_RC_02];
  dst->data[M4_RC_03] = 0.f;
  dst->data[M4_RC_10] = tmp.data[M3_RC_10];
  dst->data[M4_RC_11] = tmp.data[M3_RC_11];
  dst->data[M4_RC_12] = tmp.data[M3_RC_12];
  dst->data[M4_RC_13] = 0.f;
  dst->data[M4_RC_20] = tmp.data[M3_RC_20];
  dst->data[M4_RC_21] = tmp.data[M3_RC_21];
  dst->data[M4_RC_22] = tmp.data[M3_RC_22];
  dst->data[M4_RC_23] = 0.f;
  dst->data[M4_RC_30] = 0.f;
  dst->data[M4_RC_31] = 0.f;
  dst->data[M4_RC_32] = 0.f;
  dst->data[M4_RC_33] = 1.f;
}

// Calculate the matrix that when multiplied by another vector 'v' will give the
...
// convert our row major matrix (directx format) to column major (opengl is
// column major).
inline
void
...
determinant_m4f(const matrix4f *src)
{
  ...
  d0.data[M3_RC_00] = src->data[M4_RC_11];
  d0.data[M3_RC_01] = src->data[M4_RC_12];
  d0.data[M3_RC_02] = src->data[M4_RC_13];
  d0.data[M3_RC_10] = src->data[M4_RC_21];
  d0.data[M3_RC_11] = src->data[M4_RC_22];
  d0.data[M3_RC_12] = src->data[M4_RC_23];
  d0.data[M3_RC_20] = src->data[M4_RC_31];
  d0.data[M3_RC_21] = src->data[M4_RC_32];
  d0.data[M3_RC_22] = src->data[M4_RC_33];

  d1.data[M3_RC_00] = src->data[M4_RC_10];
  d1.data[M3_RC_01] = src->data[M4_RC_12];
  d1.data[M3_RC_02] = src->data[M4_RC_13];
  d1.data[M3_RC_10] = src->data[M4_RC_20];
  d1.data[M3_RC_11] = src->data[M4_RC_22];
  d1.data[M3_RC_12] = src->data[M4_RC_23];
  d1.data[M3_RC_20] = src->data[M4_RC_30];
  d1.data[M3_RC_21] = src->data[M4_RC_32];
  d1.data[M3_RC_22] = src->data[M4_RC_33];

  d2.data[M3_RC_00] = src->data[M4_RC_10];
  d2.data[M3_RC_01] = src->data[M4_RC_11];
  d2.data[M3_RC_02] = src->data[M4_RC_13];
  d2.data[M3_RC_10] = src->data[M4_RC_20];
  d2.data[M3_RC_11] = src->data[M4_RC_21];
  d2.data[M3_RC_12] = src->data[M4_RC_23];
  d2.data[M3_RC_20] = src->data[M4_RC_30];
  d2.data[M3_RC_21] = src->data[M4_RC_31];
  d2.data[M3_RC_22] = src->data[M4_RC_33];

  d3.data[M3_RC_00] = src->data[M4_RC_10];
  d3.data[M3_RC_01] = src->data[M4_RC_11];
  d3.data[M3_RC_02] = src->data[M4_RC_12];
  d3.data[M3_RC_10] = src->data[M4_RC_20];
  d3.data[M3_RC_11] = src->data[M4_RC_21];
  d3.data[M3_RC_12] = src->data[M4_RC_22];
  d3.data[M3_RC_20] = src->data[M4_RC_30];
  d3.data[M3_RC_21] = src->data[M4_RC_31];
  d3.data[M3_RC_22] = src->data[M4_RC_32];
...
{
  matrix4f result;
  result.data[M4_RC_00] = src->data[M4_RC_00];
  result.data[M4_RC_01] = src->data[M4_RC_10];
  result.data[M4_RC_02] = src->data[M4_RC_20];
  result.data[M4_RC_03] = src->data[M4_RC_30];
  result.data[M4_RC_10] = src->data[M4_RC_01];
  result.data[M4_RC_11] = src->data[M4_RC_11];
  result.data[M4_RC_12] = src->data[M4_RC_21];
  result.data[M4_RC_13] = src->data[M4_RC_31];
  result.data[M4_RC_20] = src->data[M4_RC_02];
  result.data[M4_RC_21] = src->data[M4_RC_12];
  result.data[M4_RC_22] = src->data[M4_RC_22];
  result.data[M4_RC_23] = src->data[M4_RC_32];
  result.data[M4_RC_30] = src->data[M4_RC_03];
  result.data[M4_RC_31] = src->data[M4_RC_13];
  result.data[M4_RC_32] = src->data[M4_RC_23];
  result.data[M4_RC_33] = src->data[M4_RC_33];
  return result;
}
...
inverse_m4f(const matrix4f *src)
{
  ...
  tmp.data[M3_RC_00] = src->data[M4_RC_11];
  tmp.data[M3_RC_01] = src->data[M4_RC_12];
  tmp.data[M3_RC_02] = src->data[M4_RC_13];
  tmp.data[M3_RC_10] = src->data[M4_RC_21];
  tmp.data[M3_RC_11] = src->data[M4_RC_22];
  tmp.data[M3_RC_12] = src->data[M4_RC_23];
  tmp.data[M3_RC_20] = src->data[M4_RC_31];
  tmp.data[M3_RC_21] = src->data[M4_RC_32];
  tmp.data[M3_RC_22] = src->data[M4_RC_33];
  det1 = determinant_m3f(&tmp);

  tmp.data[M3_RC_00] = src->data[M4_RC_10];
  tmp.data[M3_RC_01] = src->data[M4_RC_12];
  tmp.data[M3_RC_02] = src->data[M4_RC_13];
  tmp.data[M3_RC_10] = src->data[M4_RC_20];
  tmp.data[M3_RC_11] = src->data[M4_RC_22];
  tmp.data[M3_RC_12] = src->data[M4_RC_23];
  tmp.data[M3_RC_20] = src->data[M4_RC_30];
  tmp.data[M3_RC_21] = src->data[M4_RC_32];
  tmp.data[M3_RC_22] = src->data[M4_RC_33];
  det2 = determinant_m3f(&tmp);

  tmp.data[M3_RC_00] = src->data[M4_RC_10];
  tmp.data[M3_RC_01] = src->data[M4_RC_11];
  tmp.data[M3_RC_02] = src->data[M4_RC_13];
  tmp.data[M3_RC_10] = src->data[M4_RC_20];
  tmp.data[M3_RC_11] = src->data[M4_RC_21];
  tmp.data[M3_RC_12] = src->data[M4_RC_23];
  tmp.data[M3_RC_20] = src->data[M4_RC_30];
  tmp.data[M3_RC_21] = src->data[M4_RC_31];
  tmp.data[M3_RC_22] = src->data[M4_RC_33];
  det3 = determinant_m3f(&tmp);

  tmp.data[M3_RC_00] = src->data[M4_RC_10];
  tmp.data[M3_RC_01] = src->data[M4_RC_11];
  tmp.data[M3_RC_02] = src->data[M4_RC_12];
  tmp.data[M3_RC_10] = src->data[M4_RC_20];
  tmp.data[M3_RC_11] = src->data[M4_RC_21];
  tmp.data[M3_RC_12] = src->data[M4_RC_22];
  tmp.data[M3_RC_20] = src->data[M4_RC_30];
  tmp.data[M3_RC_21] = src->data[M4_RC_31];
  tmp.data[M3_RC_22] = src->data[M4_RC_32];
  det4 = determinant_m3f(&tmp);

  tmp.data[M3_RC_00] = src->data[M4_RC_01];
  tmp.data[M3_RC_01] = src->data[M4_RC_02];
  tmp.data[M3_RC_02] = src->data[M4_RC_03];
  tmp.data[M3_RC_10] = src->data[M4_RC_21];
  tmp.data[M3_RC_11] = src->data[M4_RC_22];
  tmp.data[M3_RC_12] = src->data[M4_RC_23];
  tmp.data[M3_RC_20] = src->data[M4_RC_31];
  ...
  tmp.data[M3_RC_00] = src->data[M4_RC_00];
  tmp.data[M3_RC_01] = src->data[M4_RC_02];
  tmp.data[M3_RC_02] = src->data[M4_RC_03];
  tmp.data[M3_RC_10] = src->data[M4_RC_20];
  tmp.data[M3_RC_11] = src->data[M4_RC_22];
  ...
  tmp.data[M3_RC_00] = src->data[M4_RC_00];
  tmp.data[M3_RC_01] = src->data[M4_RC_01];
  tmp.data[M3_RC_02] = src->data[M4_RC_03];
  tmp.data[M3_RC_10] = src->data[M4_RC_20];
  tmp.data[M3_RC_11] = src->data[M4_RC_21];
  tmp.data[M3_RC_12] = src->data[M4_RC_23];
  ...
  tmp.data[M3_RC_00] = src->data[M4_RC_00];
  tmp.data[M3_RC_01] = src->data[M4_RC_01];
  tmp.data[M3_RC_02] = src->data[M4_RC_02];
  tmp.data[M3_RC_10] = src->data[M4_RC_20];
  tmp.data[M3_RC_11] = src->data[M4_RC_21];
  tmp.data[M3_RC_12] = src->data[M4_RC_22];
  tmp.data[M3_RC_20] = src->data[M4_RC_30];
  ...
  tmp.data[M3_RC_01] = src->data[M4_RC_02];
  tmp.data[M3_RC_02] = src->data[M4_RC_03];
  tmp.data[M3_RC_10] = src->data[M4_RC_11];
  tmp.data[M3_RC_11] = src->data[M4_RC_12];
  tmp.data[M3_RC_12] = src->data[M4_RC_13];
  tmp.data[M3_RC_20] = src->data[M4_RC_31];
  tmp.data[M3_RC_21] = src->data[M4_RC_32];
  tmp.data[M3_RC_22] = src->data[M4_RC_33];
  ...
  tmp.data[M3_RC_01] = src->data[M4_RC_02];
  tmp.data[M3_RC_02] = src->data[M4_RC_03];
  tmp.data[M3_RC_10] = src->data[M4_RC_10];
  tmp.data[M3_RC_11] = src->data[M4_RC_12];
  tmp.data[M3_RC_12] = src->data[M4_RC_13];
  tmp.data[M3_RC_20] = src->data[M4_RC_30];
  tmp.data[M3_RC_21] = src->data[M4_RC_32];
  ...
  tmp.data[M3_RC_02] = src->data[M4_RC_03];
  tmp.data[M3_RC_10] = src->data[M4_RC_10];
  tmp.data[M3_RC_11] = src->data[M4_RC_11];
  tmp.data[M3_RC_12] = src->data[M4_RC_13];
  tmp.data[M3_RC_20] = src->data[M4_RC_30];
  tmp.data[M3_RC_21] = src->data[M4_RC_31];
  tmp.data[M3_RC_22] = src->data[M4_RC_33];
  ...
  tmp.data[M3_RC_10] = src->data[M4_RC_10];
  tmp.data[M3_RC_11] = src->data[M4_RC_11];
  tmp.data[M3_RC_12] = src->data[M4_RC_12];
  tmp.data[M3_RC_20] = src->data[M4_RC_30];
  tmp.data[M3_RC_21] = src->data[M4_RC_31];
  tmp.data[M3_RC_22] = src->data[M4_RC_32];
  ...
  tmp.data[M3_RC_11] = src->data[M4_RC_12];
  tmp.data[M3_RC_12] = src->data[M4_RC_13];
  tmp.data[M3_RC_20] = src->data[M4_RC_21];
  tmp.data[M3_RC_21] = src->data[M4_RC_22];
  tmp.data[M3_RC_22] = src->data[M4_RC_23];
  ...
  tmp.data[M3_RC_11] = src->data[M4_RC_12];
  tmp.data[M3_RC_12] = src->data[M4_RC_13];
  tmp.data[M3_RC_20] = src->data[M4_RC_20];
  tmp.data[M3_RC_21] = src->data[M4_RC_22];
  tmp.data[M3_RC_22] = src->data[M4_RC_23];
  ...
  tmp.data[M3_RC_12] = src->data[M4_RC_13];
  tmp.data[M3_RC_20] = src->data[M4_RC_20];
  tmp.data[M3_RC_21] = src->data[M4_RC_21];
  tmp.data[M3_RC_22] = src->data[M4_RC_23];
  ...
  tmp.data[M3_RC_20] = src->data[M4_RC_20];
  tmp.data[M3_RC_21] = src->data[M4_RC_21];
  tmp.data[M3_RC_22] = src->data[M4_RC_22];
  det16 = determinant_m3f(&tmp);

  result.data[M4_RC_00] = det1;
  result.data[M4_RC_01] = -det2;
  result.data[M4_RC_02] = det3;
  result.data[M4_RC_03] = -det4;
  result.data[M4_RC_10] = -det5;
  result.data[M4_RC_11] = det6;
  result.data[M4_RC_12] = -det7;
  result.data[M4_RC_13] = det8;
  result.data[M4_RC_20] = det9;
  result.data[M4_RC_21] = -det10;
  result.data[M4_RC_22] = det11;
  result.data[M4_RC_23] = -det12;
  result.data[M4_RC_30] = -det13;
  result.data[M4_RC_31] = det14;
  result.data[M4_RC_32] = -det15;
  result.data[M4_RC_33] = det16;
...
// will extract the axis and the angles in degrees from src. src should be a
// rotation matrix (otherwise result is undefined).
inline
void
...
mult_m4f_v3f(const matrix4f *lhs, const vector3f *rhs)
{
  ...
  vector3f_set_3f(
    &result,
    lhs->data[M4_RC_00] * rhs->data[0] +
    lhs->data[M4_RC_01] * rhs->data[1] +
    lhs->data[M4_RC_02] * rhs->data[2],
    lhs->data[M4_RC_10] * rhs->data[0] +
    lhs->data[M4_RC_11] * rhs->data[1] +
    lhs->data[M4_RC_12] * rhs->data[2],
    lhs->data[M4_RC_20] * rhs->data[0] +
    lhs->data[M4_RC_21] * rhs->data[1] +
    lhs->data[M4_RC_22] * rhs->data[2]);
  return result;
}
...
// point variant of the vector functionality, takes into account translation
// transformation
inline
vector3f
mult_m4f_p3f(const matrix4f *lhs, const vector3f *rhs)
{
  ...
  vector3f_set_3f(
    ...
    lhs->data[M4_RC_00] * rhs->data[0] +
    lhs->data[M4_RC_01] * rhs->data[1] +
    lhs->data[M4_RC_02] * rhs->data[2] + lhs->data[M4_RC_03],
    lhs->data[M4_RC_10] * rhs->data[0] +
    lhs->data[M4_RC_11] * rhs->data[1] +
    lhs->data[M4_RC_12] * rhs->data[2] + lhs->data[M4_RC_13],
    lhs->data[M4_RC_20] * rhs->data[0] +
    lhs->data[M4_RC_21] * rhs->data[1] +
    lhs->data[M4_RC_22] * rhs->data[2] + lhs->data[M4_RC_23]);
  return result;
}

// point variant of the vector functionality, takes into account translation
// transformation. Will return rhs address so it can be reused.
inline
vector3f*
